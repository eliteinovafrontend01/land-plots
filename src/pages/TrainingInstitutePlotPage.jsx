...
import TrainingInstitutePlotFilter from "../components/filters/TrainingInstitutePlotFilter";
import TrainingInstitutePlot from "../components/propertycard/TrainingInstitutePlot";

const TrainingInstitutePlotPage = () => {
  const navigate = useNavigate();
  const location = useLocation();
  const [activeButton, setActiveButton] = useState("Buy");
  const [activeLandType, setActiveLandType] = useState("TrainingInstitute Plot");
  ...
  useEffect(() => {
    ...
    if (activeType) {
      ...
      setActiveLandType("TrainingInstitute Plot");
    }
  }, [location.pathname]);
  ...
  const SearchBar = () => (
    <div className="relative flex-1 group">
      ...
      <input
        type="text"
        placeholder="Search TrainingInstitute Plots by city, locality, or project name"
...
export default TrainingInstitutePlotPage;