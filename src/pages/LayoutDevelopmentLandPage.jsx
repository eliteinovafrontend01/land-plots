...
import LayoutDevelopmentLandFilter from "../components/filters/LayoutDevelopmentLandFilter";
import LayoutDevelopmentLand from "../components/propertycard/LayoutDevelopmentLand";

const LayoutDevelopmentLandPage = () => {
  const navigate = useNavigate();
  const location = useLocation();
  const [activeButton, setActiveButton] = useState("Buy");
  const [activeLandType, setActiveLandType] = useState("LayoutDevelopment Land");
  ...
  useEffect(() => {
    ...
    if (activeType) {
      ...
      setActiveLandType("LayoutDevelopment Land");
    }
  }, [location.pathname]);
  ...
  const SearchBar = () => (
    <div className="relative flex-1 group">
      ...
      <input
        type="text"
        placeholder="Search LayoutDevelopment Lands by city, locality, or project name"
...
export default LayoutDevelopmentLandPage;