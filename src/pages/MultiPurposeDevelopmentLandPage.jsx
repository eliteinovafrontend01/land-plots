...
import MultiPurposeDevelopmentLandFilter from "../components/filters/MultiPurposeDevelopmentLandFilter";
import MultiPurposeDevelopmentLand from "../components/propertycard/MultiPurposeDevelopmentLand";

const MultiPurposeDevelopmentLandPage = () => {
  const navigate = useNavigate();
  const location = useLocation();
  const [activeButton, setActiveButton] = useState("Buy");
  const [activeLandType, setActiveLandType] = useState("MultiPurposeDevelopment Land");
  ...
  useEffect(() => {
    ...
    if (activeType) {
      ...
      setActiveLandType("MultiPurposeDevelopment Land");
    }
  }, [location.pathname]);
  ...
  const SearchBar = () => (
    <div className="relative flex-1 group">
      ...
      <input
        type="text"
        placeholder="Search MultiPurposeDevelopment Lands by city, locality, or project name"
          ...
          <div className="max-w-none mx-auto px-4 sm:px-6 relative z-10 text-center w-full flex flex-col items-center justify-center gap-2">
            ...
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white animate-slide-up drop-shadow-[0_0_30px_rgba(0,105,92,0.5)]">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-300 via-emerald-300 to-teal-300 animate-gradient-text">
                MultiPurposeDevelopment Land
              </span>
            </h1>
            <p className="text-sm md:text-base lg:text-lg text-white/90 max-w-3xl mx-auto leading-relaxed px-2">
              Discover premium MultiPurposeDevelopment Lands for your dream project
            </p>
        ...
        {showFilterModal && (
          <div className="fixed inset-0 z-[9999] flex items-start justify-center pt-[140px] px-4 pb-4 bg-black/50 backdrop-blur-sm animate-fade-in">
            <div className="relative w-full max-w-2xl max-h-[80vh] overflow-y-auto">
              <MultiPurposeDevelopmentLandFilter
...
export default MultiPurposeDevelopmentLandPage;