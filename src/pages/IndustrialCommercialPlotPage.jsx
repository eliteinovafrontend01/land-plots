...
import IndustrialCommercialPlotFilter from "../components/filters/IndustrialCommercialPlotFilter";
import IndustrialCommercialPlot from "../components/propertycard/IndustrialCommercialPlot";

const IndustrialCommercialPlotPage = () => {
  const navigate = useNavigate();
  const location = useLocation();
  const [activeButton, setActiveButton] = useState("Buy");
  const [activeLandType, setActiveLandType] = useState("IndustrialCommercial Plot");
  ...
  useEffect(() => {
    ...
    if (activeType) {
      ...
      setActiveLandType("IndustrialCommercial Plot");
    }
  }, [location.pathname]);
  ...
  const SearchBar = () => (
    <div className="relative flex-1 group">
      ...
      <input
        type="text"
        placeholder="Search IndustrialCommercial plots by city, locality, or project name"
        ...
        {showFilterModal && (
          <div className="fixed inset-0 z-[9999] flex items-start justify-center pt-[140px] px-4 pb-4 bg-black/50 backdrop-blur-sm animate-fade-in">
            <div className="relative w-full max-w-2xl max-h-[80vh] overflow-y-auto">
              <IndustrialCommercialPlotFilter
...
export default IndustrialCommercialPlotPage;