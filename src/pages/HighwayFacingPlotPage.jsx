...
import HighwayFacingPlotFilter from "../components/filters/HighwayFacingPlotFilter";
import HighwayFacingPlot from "../components/propertycard/HighwayFacingPlot";

const HighwayFacingPlotPage = () => {
  const navigate = useNavigate();
  const location = useLocation();
  const [activeButton, setActiveButton] = useState("Buy");
  const [activeLandType, setActiveLandType] = useState("HighwayFacing Plot");
  ...
  useEffect(() => {
    ...
    if (activeType) {
      ...
      setActiveLandType("HighwayFacing Plot");
    }
  }, [location.pathname]);
  ...
  const SearchBar = () => (
    <div className="relative flex-1 group">
      ...
      <input
        type="text"
        placeholder="Search HighwayFacing Plots by city, locality, or project name"
        ...
        <section className="w-full relative flex items-center justify-center group py-2 md:py-4">
          ...
          <div className="max-w-none mx-auto px-4 sm:px-6 relative z-10 text-center w-full flex flex-col items-center justify-center gap-2">
            ...
            <p className="text-sm md:text-base lg:text-lg text-white/90 max-w-3xl mx-auto leading-relaxed px-2">
              Discover premium HighwayFacing Plots for your dream project
            </p>
...
export default HighwayFacingPlotPage;