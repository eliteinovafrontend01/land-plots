...
import SEZLandFilter from "../components/filters/SEZLandFilter";
import SEZLand from "../components/propertycard/SEZLand";

const SEZLandPage = () => {
  const navigate = useNavigate();
  const location = useLocation();
  const [activeButton, setActiveButton] = useState("Buy");
  const [activeLandType, setActiveLandType] = useState("SEZ Land");
