...
import CommercialIndustrialLandFilter from "../components/filters/CommercialIndustrialLandFilter";
import CommercialIndustrialLand from "../components/propertycard/CommercialIndustrialLand";

const CommercialIndustrialLandPage = () => {
  const navigate = useNavigate();
  const location = useLocation();
  const [activeButton, setActiveButton] = useState("Buy");
  const [activeLandType, setActiveLandType] = useState("CommercialIndustrial Land");
  ...
  useEffect(() => {
    ...
    if (activeType) {
      ...
      setActiveLandType("CommercialIndustrial Land");
    }
  }, [location.pathname]);
  ...
  const SearchBar = () => (
    <div className="relative flex-1 group">
      ...
      <input
        type="text"
        placeholder="Search CommercialIndustrial Lands by city, locality, or project name"
        ...
        <section className="w-full relative flex items-center justify-center group py-2 md:py-4">
          ...
          <div className="max-w-none mx-auto px-4 sm:px-6 relative z-10 text-center w-full flex flex-col items-center justify-center gap-2">
            ...
            <p className="text-sm md:text-base lg:text-lg text-white/90 max-w-3xl mx-auto leading-relaxed px-2">
              Discover premium CommercialIndustrial Lands for your dream project
            </p>
        ...
        {showFilterModal && (
          <div className="fixed inset-0 z-[9999] flex items-start justify-center pt-[140px] px-4 pb-4 bg-black/50 backdrop-blur-sm animate-fade-in">
            <div className="relative w-full max-w-2xl max-h-[80vh] overflow-y-auto">
              <CommercialIndustrialLandFilter
...
export default CommercialIndustrialLandPage;