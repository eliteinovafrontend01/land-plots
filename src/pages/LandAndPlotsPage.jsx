...
import { ChevronDown, Search, Home, MapPin, Star, Filter, X, Building, Landmark, Warehouse, Building2, Store, Factory, Hotel, Briefcase, Trees } from "lucide-react";
...
const LandAndPlotsPage = () => {
  ...
  const landTypes = [
    { name: "All", path: "/land-plots", component: "LandAndPlotsPage" },
    { name: "Residential Land", path: "/land-plots/residential-land", component: "ResidentialLandPage" },
    { name: "Commercial Land", path: "/land-plots/commercial-land", component: "CommercialLandPage" },
    { name: "Agricultural Land", path: "/land-plots/agricultural-land", component: "AgriculturalLandPage" },
    { name: "Industrial Land", path: "/land-plots/industrial-land", component: "IndustrialLandPage" },
    { name: "Farmhouse / Acreage", path: "/land-plots/farmhouse-acreage", component: "FarmhouseAcreagePage" },
    { name: "Hill Station Plot", path: "/land-plots/hill-station-plot", component: "HillStationPlotPage" },
    { name: "Beachfront Land", path: "/land-plots/beachfront-land", component: "BeachfrontLandPage" },
    { name: "Lake View Plot", path: "/land-plots/lake-view-plot", component: "LakeViewPlotPage" },
    { name: "River Side Land", path: "/land-plots/river-side-land", component: "RiverSideLandPage" },
    { name: "Forest / Eco Land", path: "/land-plots/forest-eco-land", component: "ForestEcoLandPage" },
    { name: "Green Field Project", path: "/land-plots/green-field-project", component: "GreenFieldProjectPage" },
    { name: "SEZ Land", path: "/land-plots/sez-land", component: "SEZLandPage" },
    { name: "NA Plots", path: "/land-plots/na-plots", component: "NAPlotsPage" },
    { name: "Corner Plot", path: "/land-plots/corner-plot", component: "CornerPlotPage" },
    { name: "Gated Community Plot", path: "/land-plots/gated-community-plot", component: "GatedCommunityPlotPage" },
    { name: "Open Land", path: "/land-plots/open-land", component: "OpenLandPage" },
    { name: "Subdivision Plot", path: "/land-plots/subdivision-plot", component: "SubdivisionPlotPage" },
    { name: "Development Site", path: "/land-plots/development-site", component: "DevelopmentSitePage" },
    { name: "Raw Land", path: "/land-plots/raw-land", component: "RawLandPage" }
  ];
  ...
  useEffect(() => {
    ...
    } else if (currentPath === "/land-plots" || currentPath === "/land-plots/") {
  ...
  // Get icon for land type - Same icons as CommercialPage
  const getLandIcon = (typeName) => {
    // Using consistent icons from CommercialPage
    const iconMap = {
      "All": <Building className="w-3.5 h-3.5" />,
      "Residential Land": <Building className="w-3.5 h-3.5" />,
      "Commercial Land": <Building2 className="w-3.5 h-3.5" />,
      "Agricultural Land": <Warehouse className="w-3.5 h-3.5" />,
      "Industrial Land": <Factory className="w-3.5 h-3.5" />,
      "Farmhouse / Acreage": <Trees className="w-3.5 h-3.5" />,
      "Hill Station Plot": <Landmark className="w-3.5 h-3.5" />,
      "Beachfront Land": <Landmark className="w-3.5 h-3.5" />,
      "Lake View Plot": <Landmark className="w-3.5 h-3.5" />,
      "River Side Land": <Landmark className="w-3.5 h-3.5" />,
      "Forest / Eco Land": <Trees className="w-3.5 h-3.5" />,
      "Green Field Project": <Warehouse className="w-3.5 h-3.5" />,
      "SEZ Land": <Building2 className="w-3.5 h-3.5" />,
      "NA Plots": <Landmark className="w-3.5 h-3.5" />,
      "Corner Plot": <Building className="w-3.5 h-3.5" />,
      "Gated Community Plot": <Building className="w-3.5 h-3.5" />,
      "Open Land": <Landmark className="w-3.5 h-3.5" />,
      "Subdivision Plot": <Building className="w-3.5 h-3.5" />,
      "Development Site": <Building2 className="w-3.5 h-3.5" />,
      "Raw Land": <Landmark className="w-3.5 h-3.5" />
    };
  ...
  return (
    <div className="w-full min-h-screen relative">
      {/* Background - Same as CommercialPage */}
      <div 
      ...
      <div className="relative z-10">
        {/* Hero Section - Same as CommercialPage */}
        ...
        {/* Sticky Header - Same as CommercialPage */}
        <div className="bg-gradient-to-r from-teal-50/95 via-emerald-50/95 to-teal-50/95 backdrop-blur-xl shadow-2xl sticky top-0 z-40 border-b border-teal-200/30 transition-all duration-500 animate-slide-down">
          <div className="max-w-none mx-auto px-6 py-4">
            <div className="hidden md:block space-y-4">
              ...
              <div className="flex flex-wrap gap-3 max-h-auto overflow-y-auto scrollbar-thin">
                {landTypes.map((type, index) => {
                  const isActive = activeLandType === type.name;
                  return (
                    <button
                      key={type.name}
        ...
        <div className="max-w-none mx-auto px-6 py-8 lg:py-12">
          <div className="flex flex-col lg:flex-row gap-6 lg:gap-8">
              ...
              <section>
                <div className="bg-gradient-to-br from-teal-50/90 via-emerald-50/90 to-teal-50/90 backdrop-blur-xl rounded-3xl shadow-2xl p-8 lg:p-12 text-center border border-teal-200/30 hover:shadow-[0_0_60px_rgba(0,105,92,0.3)] transition-all duration-700 group animate-fade-in-up">
                  ...
                  <p className="text-teal-800 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed group-hover:text-teal-900 transition-colors duration-300 backdrop-blur-sm bg-teal-100/30 rounded-2xl p-6 border border-teal-200/20">
                    {activeLandType === "All" 
                      ? "We're currently adding verified land and plot listings to our database."
                ...
                <div className="max-w-2xl mx-auto">
                  ...
                  <p className="text-teal-800 mb-6 backdrop-blur-sm bg-teal-100/30 rounded-xl p-4 border border-teal-200/20">
                    {activeLandType !== "All"
                      ...
                      : "Use the filters on the right to find land and plots that match your criteria."}
                  </p>
            ...
            {/* Filters Sidebar - Same as CommercialPage */}
                ...
                <div className="bg-gradient-to-b from-teal-50/95 via-emerald-50/95 to-teal-50/95 backdrop-blur-xl rounded-3xl shadow-2xl p-6 border border-teal-200/30 hover:shadow-[0_0_40px_rgba(0,105,92,0.2)] transition-all duration-500">
                  ...
                  <div className="mb-6 animate-fade-in-up delay-300">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      {["Residential", "Commercial", "Agricultural", "Industrial", "Farmhouse", "Hill Station", "Beachfront", "Lake View"].map((type, index) => (
                        <label 
                          key={type} 
                  ...
                  <div className="mb-6 animate-fade-in-up delay-400">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      {["Corner Plot", "Road Access", "Water Connection", "Electricity", "Level Ground", "Clear Title", "Approved Layout", "Gated Community"].map((feature, index) => (
                        <label 
                          key={feature} 
