...
import ShoppingComplexLandFilter from "../components/filters/ShoppingComplexLandFilter";
import ShoppingComplexLand from "../components/propertycard/ShoppingComplexLand";

const ShoppingComplexLandPage = () => {
  const navigate = useNavigate();
  const location = useLocation();
  const [activeButton, setActiveButton] = useState("Buy");
  const [activeLandType, setActiveLandType] = useState("ShoppingComplex Land");
  ...
  useEffect(() => {
    ...
    if (activeType) {
      ...
      setActiveLandType("ShoppingComplex Land");
    }
  }, [location.pathname]);
  ...
  const SearchBar = () => (
    <div className="relative flex-1 group">
      ...
      <input
        type="text"
        placeholder="Search ShoppingComplex Lands by city, locality, or project name"
...
export default ShoppingComplexLandPage;