...
import TownshipDevelopmentLandFilter from "../components/filters/TownshipDevelopmentLandFilter";
import TownshipDevelopmentLand from "../components/propertycard/TownshipDevelopmentLand";

const TownshipDevelopmentLandPage = () => {
  const navigate = useNavigate();
  const location = useLocation();
  const [activeButton, setActiveButton] = useState("Buy");
  const [activeLandType, setActiveLandType] = useState("TownshipDevelopment Land");
  ...
  useEffect(() => {
    ...
    if (activeType) {
      ...
      setActiveLandType("TownshipDevelopment Land");
    }
  }, [location.pathname]);
  ...
  const SearchBar = () => (
    <div className="relative flex-1 group">
      ...
      <input
        type="text"
        placeholder="Search TownshipDevelopment Lands by city, locality, or project name"
...
export default TownshipDevelopmentLandPage;