...
import ManufacturingUnitPlotFilter from "../components/filters/ManufacturingUnitPlotFilter";
import ManufacturingUnitPlot from "../components/propertycard/ManufacturingUnitPlot";

const ManufacturingUnitPlotPage = () => {
  const navigate = useNavigate();
  const location = useLocation();
  const [activeButton, setActiveButton] = useState("Buy");
  const [activeLandType, setActiveLandType] = useState("ManufacturingUnit Plot");
  ...
  useEffect(() => {
    ...
    if (activeType) {
      ...
      setActiveLandType("ManufacturingUnit Plot");
    }
  }, [location.pathname]);
  ...
  const SearchBar = () => (
    <div className="relative flex-1 group">
      ...
      <input
        type="text"
        placeholder="Search ManufacturingUnit Plots by city, locality, or project name"
...
export default ManufacturingUnitPlotPage;