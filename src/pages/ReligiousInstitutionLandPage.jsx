...
import ReligiousInstitutionLandFilter from "../components/filters/ReligiousInstitutionLandFilter";
import ReligiousInstitutionLand from "../components/propertycard/ReligiousInstitutionLand";

const ReligiousInstitutionLandPage = () => {
  const navigate = useNavigate();
  const location = useLocation();
  const [activeButton, setActiveButton] = useState("Buy");
  const [activeLandType, setActiveLandType] = useState("ReligiousInstitution Land");
  ...
  useEffect(() => {
    ...
    if (activeType) {
      ...
      setActiveLandType("ReligiousInstitution Land");
    }
  }, [location.pathname]);
  ...
  const SearchBar = () => (
    <div className="relative flex-1 group">
      ...
      <input
        type="text"
        placeholder="Search ReligiousInstitution Lands by city, locality, or project name"
        ...
        {showFilterModal && (
          <div className="fixed inset-0 z-[9999] flex items-start justify-center pt-[140px] px-4 pb-4 bg-black/50 backdrop-blur-sm animate-fade-in">
            <div className="relative w-full max-w-2xl max-h-[80vh] overflow-y-auto">
              <ReligiousInstitutionLandFilter
...
export default ReligiousInstitutionLandPage;