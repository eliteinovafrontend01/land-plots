...
import ResidentialCommercialPlotFilter from "../components/filters/ResidentialCommercialPlotFilter";
import ResidentialCommercialPlot from "../components/propertycard/ResidentialCommercialPlot";

const ResidentialCommercialPlotPage = () => {
  const navigate = useNavigate();
  const location = useLocation();
  const [activeButton, setActiveButton] = useState("Buy");
  const [activeLandType, setActiveLandType] = useState("ResidentialCommercial Plot");
  ...
  useEffect(() => {
    ...
    if (activeType) {
      ...
      setActiveLandType("ResidentialCommercial Plot");
    }
  }, [location.pathname]);
  ...
  const SearchBar = () => (
    <div className="relative flex-1 group">
      ...
      <input
        type="text"
        placeholder="Search ResidentialCommercial Plots by city, locality, or project name"
        ...
        {showFilterModal && (
          <div className="fixed inset-0 z-[9999] flex items-start justify-center pt-[140px] px-4 pb-4 bg-black/50 backdrop-blur-sm animate-fade-in">
            <div className="relative w-full max-w-2xl max-h-[80vh] overflow-y-auto">
              <ResidentialCommercialPlotFilter
...
export default ResidentialCommercialPlotPage;