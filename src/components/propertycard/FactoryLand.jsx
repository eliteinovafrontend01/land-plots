...
import { FactoryLandData } from "../data/FactoryLandData";

const PAGE_NAME = "Factory Land";
...
const FactoryLand = () => {
  ...
  const [filteredProperties, setFilteredProperties] = useState(FactoryLandData);
          ...
          <div className="flex flex-col gap-5">
            {filteredProperties.length > 0 ? (
              ...
              <div className="w-full bg-white rounded-2xl shadow-2xl border border-teal-100 p-8 text-center">
                ...
                <p className="text-xs text-slate-500">No FactoryLand apartments available at the moment.</p>
              </div>
            )}
          </div>
        </div>
