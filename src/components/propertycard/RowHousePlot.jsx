...
import { RowHousePlotData } from "../data/RowHousePlotData";

const PAGE_NAME = "RowHousePlot";
...
const RowHousePlot = () => {
  ...
  const [filteredProperties, setFilteredProperties] = useState(RowHousePlotData);
          ...
          <div className="flex flex-col gap-5">
            {filteredProperties.length > 0 ? (
              ...
              <div className="w-full bg-white rounded-2xl shadow-2xl border border-teal-100 p-8 text-center">
                ...
                <p className="text-xs text-slate-500">No RowHousePlot apartments available at the moment.</p>
              </div>
            )}
          </div>
        </div>
