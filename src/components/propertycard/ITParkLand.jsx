...
import { ITParkLandData } from "../data/ITParkLandData";

const PAGE_NAME = "ITPark Land";
...
const ITParkLand = () => {
  ...
  const [filteredProperties, setFilteredProperties] = useState(ITParkLandData);
          ...
          <div className="flex flex-col gap-5">
            {filteredProperties.length > 0 ? (
              ...
              <div className="w-full bg-white rounded-2xl shadow-2xl border border-teal-100 p-8 text-center">
                ...
                <p className="text-xs text-slate-500">No ITParkLand apartments available at the moment.</p>
              </div>
            )}
          </div>
        </div>
