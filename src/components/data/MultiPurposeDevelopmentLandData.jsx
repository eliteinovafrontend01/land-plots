...
export const MultiPurposeDevelopmentLandData = [
  ...
  // RENT - Heritage Villa (Posted by AGENT)
  {
    ...
    agentDetails: "🏛️ Heritage property specialist | Verified agent | Best MultiPurposeDevelopmentLand deals in Mylapore",
